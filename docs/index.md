...
## CCA RO-Crate Profile description

A CCA RO-Crate MAY include at least one of the following entities (and MUST have the specified @type):

| Entity name | Entity Type | @type |
|---|---|---|
| Minimal Viable Product (MVP) | contextual  | Product |
| Variable Measured | contextual  | Variable | 
| Project  | contextual  | Project | 
| Network  | contextual  | Network | 
| Campaign  | contextual  | Campaign | 
| Dataset  | data  | Dataset | 

@id: MUST be:
- For contextual entities a URI, which COULD be a resolvable PID 
- For data entities, either a URI Path relative to the RO Crate root, or an absolute URI, which can point to a file with the dataset or to a Web service call that allows retrieving/generating the dataset on demand.
...
#### Properties to link main entities
The properties to link the main entities from the RO-Crate (or other entity) are:

| Entity name | property | Description (Purpose/Comments) |
|---|---|---|
| Minimal Viable Product (MVP) |  schema:isRelatedTo | Defines a relationship with a MVP contextual entity |
| Variable Measured | schema:variableMeasured | Defines a relationship with a Variable contextual entity |
| Project  | schema:publisher | Defines a relationship with a Project contextual entity |
| Network  | cca:hasNetwork | Defines a relationship with a Network contextual entity |
| Campaign  | cca:hasCampaign | Defines the relationship with the Campaign contextual entity  |
| Dataset  | schema:hasPart | Aggregates a Dataset data entity in the RO-Crate. To relate a Dataset from another entity, use schema:dataset|
...
| data management plan (DMP) reference | object property | may | cca:dmp_id | Identifies DMP for each type of data |
...
| data manager | object property| may | citedcat:dataManager | Data responsible persons |
...
| has dissemination/reuse | object property | may | dpv:hasProcessing | Defines the relationship with the Dissemitate contextual entity |
...
| data reuse | data property | may | cca:reusedData | Reuse of existing data |
...
| carrier organisation | data property | may | dcat:catalog | Repository and organization name |
...
| dissemination manager | object property | should | cca:dataDisseminationManager | Dissemination/Reuse responsible |
...
| format / Access Software | data property | may | dcat:mediaType | File extension (pdf, xls, doc, txt, rdf) |
...
| format | data property | may | dct:format | Metadata format |
...
| Term name | type | should/may | Semantic term | Description (Purpose/Comments) |
|---|---|---|---|---|
| **Catalog** | class | may | dcat:Catalog | Defines the Catalog entity in the metadata model |
| name | data property | may | schema:name | Captures the literal value for name |
| description | data property | may | schema:description | Captures the literal value for description (e.g., number, text, date) |
| hostingInstitution | object property | may | citedcat:hostingInstitution | the organisation allowing the resource to be available on the Internet |
